...
export default function About() {
    return (
                ...
                <div class="prose">
                    <Image src="/crown_jewel20_2mb.jpg" height="432px" width="768" alt="A man rock climbing a large boulder."/>
                    <div className='px-10'>
                        <p className="text-gray-500 text-xs">Raines Demint, Crown Jewel (V10) Lake Tahoe</p>
                        <h2 className='text-slate-800'>Why this site</h2>
                        <p>Thse days when it comes time to shop for a new pad, I go for Organic.  "Pads are cheaper than injuries", I always say.  The foam, build quality, and custom color scheme are worth the extra dollars. </p>
